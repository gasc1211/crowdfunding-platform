        ...
        <div className="text-foreground py-24 sm:py-32 mt-4 flex grow flex-col gap-4 md:flex-row rounded-3xl">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    ...
                    <p className="mt-2 text-lg leading-8  text-center">
                        Vea algunos de los increíbles proyectos que se han
                        financiado a través de AgroSmart.
                    </p>
                </div>
                <div className="mx-auto mt-10 grid max-w-2x1 grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    {posts.map((post) => (
                        <div
                            key={post.id}
                            className="max-w-sm bg-white border bg-opacity-85 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
                        >
                            <Link href="#">
                                <Image
                                    className="rounded-t-lg w-[250px] h-[200px] m-auto mt-5"
                            ...
                            <article
                                key={post.id}
                                className="flex max-w-xl flex-col items-start justify-between text-center"
                            >
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    ...
                    <p className="mt-2 text-lg leading-8  text-center">
                        Conozca a algunos de los increíbles pequeños
                        agricultores y productores que forman parte de la
                        comunidad AgroSmart.
                    </p>
                </div>
                <div className="mx-auto mt-10 grid max-w-2x1 grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 lg:mx-0 lg:max-w-none lg:grid-cols-2">
